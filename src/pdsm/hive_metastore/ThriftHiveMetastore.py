...
class Processor(FacebookService.Processor, Iface, TProcessor):
    ...
    def process_create_table_with_constraints(self, seqid, iprot, oprot):
        ...
        result = create_table_with_constraints_result()
        try:
            self._handler.create_table_with_constraints(args.tbl, args.primaryKeys, args.foreignKeys, args.uniqueConstraints, args.notNullConstraints, args.defaultConstraints, args.checkConstraints)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except AlreadyExistsException as o1:
...
class getMetaConf_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class setMetaConf_result(TBase):
    """
    Attributes:
     - o1
    """
...
class create_catalog_args(TBase):
    """
    Attributes:
     - catalog
    """
...
create_catalog_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'catalog', [CreateCatalogRequest, None], None, ),  # 1
)


class create_catalog_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_catalog_args(TBase):
    """
    Attributes:
     - rqst
    """
...
alter_catalog_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [AlterCatalogRequest, None], None, ),  # 1
)


class alter_catalog_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
get_catalog_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'catName', [GetCatalogRequest, None], None, ),  # 1
)


class get_catalog_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_catalog_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [GetCatalogResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class get_catalogs_args(TBase):
...
class get_catalogs_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_catalogs_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [GetCatalogsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
)


class drop_catalog_args(TBase):
    """
    Attributes:
     - catName
    """
...
drop_catalog_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'catName', [DropCatalogRequest, None], None, ),  # 1
)


class drop_catalog_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class create_database_args(TBase):
    """
    Attributes:
     - database
    """
...
class create_database_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_database_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_database_args(TBase):
    """
    Attributes:
     - name
     - deleteData
...
class drop_database_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_databases_args(TBase):
    """
    Attributes:
     - pattern
    """
...
class get_databases_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_all_databases_args(TBase):
...
class get_all_databases_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class alter_database_args(TBase):
    """
    Attributes:
     - dbname
     - db
...
class alter_database_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class create_type_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_type_all_result(TBase):
    """
    Attributes:
     - success
     - o2
...
class get_fields_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - table_name
...
class get_fields_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_schema_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - table_name
...
class get_schema_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class create_table_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class create_table_with_environment_context_args(TBase):
    """
    Attributes:
     - tbl
     - environment_context
...
class create_table_with_environment_context_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class create_table_with_constraints_args(TBase):
    """
    Attributes:
     - tbl
     - primaryKeys
    ...
    def __init__(self, tbl=None, primaryKeys=None, foreignKeys=None, uniqueConstraints=None, notNullConstraints=None, defaultConstraints=None, checkConstraints=None,):
        self.tbl = tbl
...
create_table_with_constraints_args.thrift_spec = (
    ...
    (4, TType.LIST, 'uniqueConstraints', (TType.STRUCT, [SQLUniqueConstraint, None], False), None, ),  # 4
    (5, TType.LIST, 'notNullConstraints', (TType.STRUCT, [SQLNotNullConstraint, None], False), None, ),  # 5
    (6, TType.LIST, 'defaultConstraints', (TType.STRUCT, [SQLDefaultConstraint, None], False), None, ),  # 6
    (7, TType.LIST, 'checkConstraints', (TType.STRUCT, [SQLCheckConstraint, None], False), None, ),  # 7
)


class create_table_with_constraints_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class drop_constraint_args(TBase):
    """
    Attributes:
     - req
    """
...
class drop_constraint_result(TBase):
    """
    Attributes:
     - o1
     - o3
...
class add_primary_key_args(TBase):
    """
    Attributes:
     - req
    """
...
class add_primary_key_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_foreign_key_args(TBase):
    """
    Attributes:
     - req
    """
...
class add_foreign_key_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_unique_constraint_args(TBase):
    """
    Attributes:
     - req
    """
...
add_unique_constraint_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [AddUniqueConstraintRequest, None], None, ),  # 1
)


class add_unique_constraint_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_not_null_constraint_args(TBase):
    """
    Attributes:
     - req
    """
...
add_not_null_constraint_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [AddNotNullConstraintRequest, None], None, ),  # 1
)


class add_not_null_constraint_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_default_constraint_args(TBase):
    """
    Attributes:
     - req
    """
...
add_default_constraint_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [AddDefaultConstraintRequest, None], None, ),  # 1
)


class add_default_constraint_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_check_constraint_args(TBase):
    """
    Attributes:
     - req
    """
...
add_check_constraint_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [AddCheckConstraintRequest, None], None, ),  # 1
)


class add_check_constraint_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class drop_table_with_environment_context_args(TBase):
    """
    Attributes:
     - dbname
     - name
...
class drop_table_with_environment_context_result(TBase):
    """
    Attributes:
     - o1
     - o3
...
class truncate_table_args(TBase):
    """
    Attributes:
     - dbName
     - tableName
...
class truncate_table_result(TBase):
    """
    Attributes:
     - o1
    """
...
class get_tables_by_type_args(TBase):
    """
    Attributes:
     - db_name
     - pattern
...
class get_tables_by_type_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_materialized_views_for_rewriting_args(TBase):
    """
    Attributes:
     - db_name
    """
...
class get_materialized_views_for_rewriting_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_table_meta_args(TBase):
    """
    Attributes:
     - db_patterns
     - tbl_patterns
...
class get_table_meta_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_all_tables_args(TBase):
    """
    Attributes:
     - db_name
    """
...
class get_all_tables_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_table_objects_by_name_args(TBase):
    """
    Attributes:
     - dbname
     - tbl_names
...
class get_table_objects_by_name_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_table_req_args(TBase):
    """
    Attributes:
     - req
    """
...
class get_table_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_table_objects_by_name_req_args(TBase):
    """
    Attributes:
     - req
    """
...
class get_table_objects_by_name_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_materialization_invalidation_info_args(TBase):
    """
    Attributes:
     - creation_metadata
     - validTxnList
...
class get_materialization_invalidation_info_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_materialization_invalidation_info_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [Materialization, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [UnknownDBException, None], None, ),  # 3
)
...
class update_creation_metadata_args(TBase):
    """
    Attributes:
     - catName
     - dbname
...
update_creation_metadata_args.thrift_spec = (
    ...
    (4, TType.STRUCT, 'creation_metadata', [CreationMetadata, None], None, ),  # 4
)


class update_creation_metadata_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_table_names_by_filter_args(TBase):
    """
    Attributes:
     - dbname
     - filter
...
class get_table_names_by_filter_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class alter_table_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_table_with_environment_context_args(TBase):
    """
    Attributes:
     - dbname
     - tbl_name
...
class alter_table_with_environment_context_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_table_with_cascade_args(TBase):
    """
    Attributes:
     - dbname
     - tbl_name
...
class alter_table_with_cascade_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_partition_args(TBase):
    """
    Attributes:
     - new_part
    """
...
class add_partition_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class add_partition_with_environment_context_args(TBase):
    """
    Attributes:
     - new_part
     - environment_context
...
class add_partition_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class add_partitions_args(TBase):
    """
    Attributes:
     - new_parts
    """
...
class add_partitions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class add_partitions_pspec_args(TBase):
    """
    Attributes:
     - new_parts
    """
...
class add_partitions_pspec_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class append_partition_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class append_partition_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class add_partitions_req_args(TBase):
    """
    Attributes:
     - request
    """
...
class add_partitions_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class append_partition_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class append_partition_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class append_partition_by_name_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class append_partition_by_name_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class append_partition_by_name_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class append_partition_by_name_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_partition_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class drop_partition_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_partition_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class drop_partition_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_partition_by_name_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class drop_partition_by_name_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_partition_by_name_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class drop_partition_by_name_with_environment_context_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class drop_partitions_req_args(TBase):
    """
    Attributes:
     - req
    """
...
class drop_partitions_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class exchange_partition_args(TBase):
    """
    Attributes:
     - partitionSpecs
     - source_db
...
class exchange_partition_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class exchange_partitions_args(TBase):
    """
    Attributes:
     - partitionSpecs
     - source_db
...
class exchange_partitions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_with_auth_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_with_auth_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_by_name_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_by_name_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_with_auth_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_with_auth_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_pspec_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_pspec_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_names_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_names_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_values_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_partition_values_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_ps_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_ps_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_ps_with_auth_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_ps_with_auth_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_names_ps_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_names_ps_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_by_filter_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_by_filter_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_part_specs_by_filter_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_part_specs_by_filter_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_by_expr_args(TBase):
    """
    Attributes:
     - req
    """
...
class get_partitions_by_expr_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_num_partitions_by_filter_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_num_partitions_by_filter_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_by_names_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partitions_by_names_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class alter_partition_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class alter_partition_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_partitions_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class alter_partitions_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_partitions_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class alter_partitions_with_environment_context_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_partition_with_environment_context_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class alter_partition_with_environment_context_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class rename_partition_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class rename_partition_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class partition_name_has_valid_characters_args(TBase):
    """
    Attributes:
     - part_vals
     - throw_exception
...
class partition_name_has_valid_characters_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class partition_name_to_vals_args(TBase):
    """
    Attributes:
     - part_name
    """
...
class partition_name_to_vals_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class partition_name_to_spec_args(TBase):
    """
    Attributes:
     - part_name
    """
...
class partition_name_to_spec_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class markPartitionForEvent_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class markPartitionForEvent_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class isPartitionMarkedForEvent_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class isPartitionMarkedForEvent_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_primary_keys_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_primary_keys_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_foreign_keys_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_foreign_keys_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_unique_constraints_args(TBase):
    """
    Attributes:
     - request
    """
...
get_unique_constraints_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [UniqueConstraintsRequest, None], None, ),  # 1
)


class get_unique_constraints_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_unique_constraints_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [UniqueConstraintsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
)


class get_not_null_constraints_args(TBase):
    """
    Attributes:
     - request
    """
...
get_not_null_constraints_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [NotNullConstraintsRequest, None], None, ),  # 1
)


class get_not_null_constraints_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_not_null_constraints_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [NotNullConstraintsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
)


class get_default_constraints_args(TBase):
    """
    Attributes:
     - request
    """
...
get_default_constraints_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [DefaultConstraintsRequest, None], None, ),  # 1
)


class get_default_constraints_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_default_constraints_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [DefaultConstraintsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
)


class get_check_constraints_args(TBase):
    """
    Attributes:
     - request
    """
...
get_check_constraints_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [CheckConstraintsRequest, None], None, ),  # 1
)


class get_check_constraints_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_check_constraints_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CheckConstraintsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
)


class update_table_column_statistics_args(TBase):
    """
    Attributes:
     - stats_obj
    """
...
class update_table_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class update_partition_column_statistics_args(TBase):
    """
    Attributes:
     - stats_obj
    """
...
class update_partition_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_table_column_statistics_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_table_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partition_column_statistics_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class get_partition_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_table_statistics_req_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_table_statistics_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_partitions_statistics_req_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_partitions_statistics_req_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_aggr_stats_for_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_aggr_stats_for_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class set_aggr_stats_for_args(TBase):
    """
    Attributes:
     - request
    """
...
class set_aggr_stats_for_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class delete_partition_column_statistics_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class delete_partition_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class delete_table_column_statistics_args(TBase):
    """
    Attributes:
     - db_name
     - tbl_name
...
class delete_table_column_statistics_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class create_function_args(TBase):
    """
    Attributes:
     - func
    """
...
class create_function_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class drop_function_args(TBase):
    """
    Attributes:
     - dbName
     - funcName
...
class drop_function_result(TBase):
    """
    Attributes:
     - o1
     - o3
...
class alter_function_args(TBase):
    """
    Attributes:
     - dbName
     - funcName
...
class alter_function_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_functions_args(TBase):
    """
    Attributes:
     - dbName
     - pattern
...
class get_functions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_function_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_all_functions_args(TBase):
...
class get_all_functions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class create_role_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_role_names_args(TBase):
...
class get_role_names_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class revoke_role_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class grant_revoke_role_args(TBase):
    """
    Attributes:
     - request
    """
...
class grant_revoke_role_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_principals_in_role_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_principals_in_role_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_role_grants_for_principal_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_role_grants_for_principal_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_privilege_set_args(TBase):
    """
    Attributes:
     - hiveObject
     - user_name
...
class get_privilege_set_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class list_privileges_args(TBase):
    """
    Attributes:
     - principal_name
     - principal_type
...
class list_privileges_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class grant_privileges_args(TBase):
    """
    Attributes:
     - privileges
    """
...
class grant_privileges_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class revoke_privileges_args(TBase):
    """
    Attributes:
     - privileges
    """
...
class revoke_privileges_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class grant_revoke_privileges_args(TBase):
    """
    Attributes:
     - request
    """
...
class grant_revoke_privileges_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class refresh_privileges_args(TBase):
    """
    Attributes:
     - objToRefresh
     - authorizer
...
refresh_privileges_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'objToRefresh', [HiveObjectRef, None], None, ),  # 1
    (2, TType.STRING, 'authorizer', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'grantRequest', [GrantRevokePrivilegeRequest, None], None, ),  # 3
)


class refresh_privileges_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_delegation_token_args(TBase):
    """
    Attributes:
     - token_owner
     - renewer_kerberos_principal_name
...
class get_delegation_token_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class renew_delegation_token_args(TBase):
    """
    Attributes:
     - token_str_form
    """
...
class renew_delegation_token_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class cancel_delegation_token_args(TBase):
    """
    Attributes:
     - token_str_form
    """
...
class cancel_delegation_token_result(TBase):
    """
    Attributes:
     - o1
    """
...
class remove_token_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_all_token_identifiers_args(TBase):
...
class get_all_token_identifiers_result(TBase):
    """
    Attributes:
     - success
    """
...
class add_master_key_args(TBase):
    """
    Attributes:
     - key
    """
...
class add_master_key_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class update_master_key_args(TBase):
    """
    Attributes:
     - seq_number
     - key
...
class update_master_key_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class remove_master_key_args(TBase):
    """
    Attributes:
     - key_seq
    """
...
class remove_master_key_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_master_keys_args(TBase):
...
class get_master_keys_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_open_txns_args(TBase):
...
class get_open_txns_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_open_txns_info_args(TBase):
...
class get_open_txns_info_result(TBase):
    """
    Attributes:
     - success
    """
...
class repl_tbl_writeid_state_args(TBase):
    """
    Attributes:
     - rqst
    """
...
repl_tbl_writeid_state_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [ReplTblWriteIdStateRequest, None], None, ),  # 1
)


class repl_tbl_writeid_state_result(TBase):
...
class get_valid_write_ids_args(TBase):
    """
    Attributes:
     - rqst
    """
...
get_valid_write_ids_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [GetValidWriteIdsRequest, None], None, ),  # 1
)


class get_valid_write_ids_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_valid_write_ids_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [GetValidWriteIdsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchTxnException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class allocate_table_write_ids_args(TBase):
    """
    Attributes:
     - rqst
    """
...
allocate_table_write_ids_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [AllocateTableWriteIdsRequest, None], None, ),  # 1
)


class allocate_table_write_ids_result(TBase):
    """
    Attributes:
     - success
     - o1
...
allocate_table_write_ids_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [AllocateTableWriteIdsResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchTxnException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [TxnAbortedException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class heartbeat_txn_range_args(TBase):
    """
    Attributes:
     - txns
    """
...
class heartbeat_txn_range_result(TBase):
    """
    Attributes:
     - success
    """
...
class show_compact_result(TBase):
    """
    Attributes:
     - success
    """
...
class add_dynamic_partitions_args(TBase):
    """
    Attributes:
     - rqst
    """
...
class add_dynamic_partitions_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_next_notification_args(TBase):
    """
    Attributes:
     - rqst
    """
...
class get_next_notification_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_current_notificationEventId_args(TBase):
...
class get_current_notificationEventId_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_notification_events_count_args(TBase):
    """
    Attributes:
     - rqst
    """
...
get_notification_events_count_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [NotificationEventsCountRequest, None], None, ),  # 1
)


class get_notification_events_count_result(TBase):
    """
    Attributes:
     - success
    """
...
get_notification_events_count_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [NotificationEventsCountResponse, None], None, ),  # 0
)


class fire_listener_event_args(TBase):
    """
    Attributes:
     - rqst
    """
...
class fire_listener_event_result(TBase):
    """
    Attributes:
     - success
    """
...
cm_recycle_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [CmRecycleRequest, None], None, ),  # 1
)


class cm_recycle_result(TBase):
    """
    Attributes:
     - success
     - o1
...
cm_recycle_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [CmRecycleResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
)


class get_file_metadata_by_expr_args(TBase):
    """
    Attributes:
     - req
    """
...
class get_file_metadata_by_expr_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_file_metadata_args(TBase):
    """
    Attributes:
     - req
    """
...
class get_file_metadata_result(TBase):
    """
    Attributes:
     - success
    """
...
class put_file_metadata_args(TBase):
    """
    Attributes:
     - req
    """
...
class put_file_metadata_result(TBase):
    """
    Attributes:
     - success
    """
...
class clear_file_metadata_args(TBase):
    """
    Attributes:
     - req
    """
...
class clear_file_metadata_result(TBase):
    """
    Attributes:
     - success
    """
...
class cache_file_metadata_args(TBase):
    """
    Attributes:
     - req
    """
...
class cache_file_metadata_result(TBase):
    """
    Attributes:
     - success
    """
...
class get_metastore_db_uuid_args(TBase):
...
class get_metastore_db_uuid_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class create_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
create_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMCreateResourcePlanRequest, None], None, ),  # 1
)


class create_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
create_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMCreateResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class get_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
get_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMGetResourcePlanRequest, None], None, ),  # 1
)


class get_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMGetResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class get_active_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
get_active_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMGetActiveResourcePlanRequest, None], None, ),  # 1
)


class get_active_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o2
...
get_active_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMGetActiveResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 1
)


class get_all_resource_plans_args(TBase):
    """
    Attributes:
     - request
    """
...
get_all_resource_plans_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMGetAllResourcePlanRequest, None], None, ),  # 1
)


class get_all_resource_plans_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_all_resource_plans_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMGetAllResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
)


class alter_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
alter_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMAlterResourcePlanRequest, None], None, ),  # 1
)


class alter_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
alter_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMAlterResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class validate_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
validate_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMValidateResourcePlanRequest, None], None, ),  # 1
)


class validate_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
validate_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMValidateResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class drop_resource_plan_args(TBase):
    """
    Attributes:
     - request
    """
...
drop_resource_plan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMDropResourcePlanRequest, None], None, ),  # 1
)


class drop_resource_plan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
drop_resource_plan_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMDropResourcePlanResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class create_wm_trigger_args(TBase):
    """
    Attributes:
     - request
    """
...
create_wm_trigger_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMCreateTriggerRequest, None], None, ),  # 1
)


class create_wm_trigger_result(TBase):
    """
    Attributes:
     - success
     - o1
...
create_wm_trigger_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMCreateTriggerResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [InvalidObjectException, None], None, ),  # 3
    (4, TType.STRUCT, 'o4', [MetaException, None], None, ),  # 4
)


class alter_wm_trigger_args(TBase):
    """
    Attributes:
     - request
    """
...
alter_wm_trigger_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMAlterTriggerRequest, None], None, ),  # 1
)


class alter_wm_trigger_result(TBase):
    """
    Attributes:
     - success
     - o1
...
alter_wm_trigger_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMAlterTriggerResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class drop_wm_trigger_args(TBase):
    """
    Attributes:
     - request
    """
...
drop_wm_trigger_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMDropTriggerRequest, None], None, ),  # 1
)


class drop_wm_trigger_result(TBase):
    """
    Attributes:
     - success
     - o1
...
drop_wm_trigger_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMDropTriggerResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class get_triggers_for_resourceplan_args(TBase):
    """
    Attributes:
     - request
    """
...
class get_triggers_for_resourceplan_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class create_wm_pool_args(TBase):
    """
    Attributes:
     - request
    """
...
create_wm_pool_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMCreatePoolRequest, None], None, ),  # 1
)


class create_wm_pool_result(TBase):
    """
    Attributes:
     - success
     - o1
...
create_wm_pool_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMCreatePoolResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [InvalidObjectException, None], None, ),  # 3
    (4, TType.STRUCT, 'o4', [MetaException, None], None, ),  # 4
...
class alter_wm_pool_args(TBase):
    """
    Attributes:
     - request
    """
...
alter_wm_pool_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMAlterPoolRequest, None], None, ),  # 1
)


class alter_wm_pool_result(TBase):
    """
    Attributes:
     - success
     - o1
...
alter_wm_pool_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMAlterPoolResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [InvalidObjectException, None], None, ),  # 3
    (4, TType.STRUCT, 'o4', [MetaException, None], None, ),  # 4
...
drop_wm_pool_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMDropPoolRequest, None], None, ),  # 1
)


class drop_wm_pool_result(TBase):
    """
    Attributes:
     - success
     - o1
...
drop_wm_pool_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMDropPoolResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class create_or_update_wm_mapping_args(TBase):
    """
    Attributes:
     - request
    """
...
create_or_update_wm_mapping_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMCreateOrUpdateMappingRequest, None], None, ),  # 1
)


class create_or_update_wm_mapping_result(TBase):
    """
    Attributes:
     - success
     - o1
...
create_or_update_wm_mapping_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMCreateOrUpdateMappingResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [InvalidObjectException, None], None, ),  # 3
    (4, TType.STRUCT, 'o4', [MetaException, None], None, ),  # 4
...
class drop_wm_mapping_args(TBase):
    """
    Attributes:
     - request
    """
...
drop_wm_mapping_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMDropMappingRequest, None], None, ),  # 1
)


class drop_wm_mapping_result(TBase):
    """
    Attributes:
     - success
     - o1
...
drop_wm_mapping_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMDropMappingResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [InvalidOperationException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [MetaException, None], None, ),  # 3
)
...
class create_or_drop_wm_trigger_to_pool_mapping_args(TBase):
    """
    Attributes:
     - request
    """
...
create_or_drop_wm_trigger_to_pool_mapping_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [WMCreateOrDropTriggerToPoolMappingRequest, None], None, ),  # 1
)


class create_or_drop_wm_trigger_to_pool_mapping_result(TBase):
    """
    Attributes:
     - success
     - o1
...
create_or_drop_wm_trigger_to_pool_mapping_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [WMCreateOrDropTriggerToPoolMappingResponse, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [AlreadyExistsException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [NoSuchObjectException, None], None, ),  # 2
    (3, TType.STRUCT, 'o3', [InvalidObjectException, None], None, ),  # 3
    (4, TType.STRUCT, 'o4', [MetaException, None], None, ),  # 4
...
class create_ischema_args(TBase):
    """
    Attributes:
     - schema
    """
...
create_ischema_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'schema', [ISchema, None], None, ),  # 1
)


class create_ischema_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class alter_ischema_args(TBase):
    """
    Attributes:
     - rqst
    """
...
alter_ischema_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [AlterISchemaRequest, None], None, ),  # 1
)


class alter_ischema_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_ischema_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_ischema_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ISchema, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class drop_ischema_args(TBase):
    """
    Attributes:
     - name
    """
...
class drop_ischema_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class add_schema_version_args(TBase):
    """
    Attributes:
     - schemaVersion
    """
...
add_schema_version_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'schemaVersion', [SchemaVersion, None], None, ),  # 1
)


class add_schema_version_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_schema_version_args(TBase):
    """
    Attributes:
     - schemaVersion
    """
...
class get_schema_version_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_schema_version_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [SchemaVersion, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class get_schema_latest_version_args(TBase):
    """
    Attributes:
     - schemaName
    """
...
get_schema_latest_version_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'schemaName', [ISchemaName, None], None, ),  # 1
)


class get_schema_latest_version_result(TBase):
    """
    Attributes:
     - success
     - o1
...
class get_schema_all_versions_args(TBase):
    """
    Attributes:
     - schemaName
    """
...
class get_schema_all_versions_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_schema_all_versions_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [SchemaVersion, None], False), None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class drop_schema_version_args(TBase):
    """
    Attributes:
     - schemaVersion
    """
...
class drop_schema_version_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class get_schemas_by_cols_args(TBase):
    """
    Attributes:
     - rqst
    """
...
get_schemas_by_cols_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [FindSchemasByColsRqst, None], None, ),  # 1
)


class get_schemas_by_cols_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_schemas_by_cols_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [FindSchemasByColsResp, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
)


class map_schema_version_to_serde_args(TBase):
    """
    Attributes:
     - rqst
    """
...
map_schema_version_to_serde_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [MapSchemaVersionToSerdeRequest, None], None, ),  # 1
)


class map_schema_version_to_serde_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
class set_schema_version_state_args(TBase):
    """
    Attributes:
     - rqst
    """
...
set_schema_version_state_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [SetSchemaVersionStateRequest, None], None, ),  # 1
)


class set_schema_version_state_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
add_serde_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'serde', [SerDeInfo, None], None, ),  # 1
)


class add_serde_result(TBase):
    """
    Attributes:
     - o1
     - o2
...
get_serde_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [GetSerdeRequest, None], None, ),  # 1
)


class get_serde_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_serde_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [SerDeInfo, None], None, ),  # 0
    (1, TType.STRUCT, 'o1', [NoSuchObjectException, None], None, ),  # 1
    (2, TType.STRUCT, 'o2', [MetaException, None], None, ),  # 2
)


class get_lock_materialization_rebuild_args(TBase):
    """
    Attributes:
     - dbName
     - tableName
...
class get_lock_materialization_rebuild_result(TBase):
    """
    Attributes:
     - success
    """
...
class heartbeat_lock_materialization_rebuild_args(TBase):
    """
    Attributes:
     - dbName
     - tableName
...
class heartbeat_lock_materialization_rebuild_result(TBase):
    """
    Attributes:
     - success
    """
...
class add_runtime_stats_args(TBase):
    """
    Attributes:
     - stat
    """
...
add_runtime_stats_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'stat', [RuntimeStat, None], None, ),  # 1
)


class add_runtime_stats_result(TBase):
    """
    Attributes:
     - o1
    """
...
class get_runtime_stats_args(TBase):
    """
    Attributes:
     - rqst
    """
...
get_runtime_stats_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'rqst', [GetRuntimeStatsRequest, None], None, ),  # 1
)


class get_runtime_stats_result(TBase):
    """
    Attributes:
     - success
     - o1
...
get_runtime_stats_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [RuntimeStat, None], False), None, ),  # 0
    (1, TType.STRUCT, 'o1', [MetaException, None], None, ),  # 1
)
